...
function SituazioneFornitori() {
 ...
 // ✅ EXPORT PDF (semplificato - senza funzioni complesse)
...
<body>
  ...
  <div class="summary">
    ...
    <p><strong>Residuo da Pagare:</strong> € ${importoTotaleDaSaldare.toFixed(2)}</p>
  </div>
